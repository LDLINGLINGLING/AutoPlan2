...
def get_question(model_path,save_question_json,inference_batch_size,tensor_parallel_size):
...
def get_complex_question(model_path,save_complex_question_json, complex_example_json, inference_batch_size=8,tensor_parallel_size=8):
...
def get_react_data(model_path,input_question_json, save_react_qa_json,inference_batch_size=8,tensor_parallel_size=8):
    tokenizer = AutoTokenizer.from_pretrained(model_path,trust_remote_code = True)
...
def get_complex_react_data(tensor_parallel_size):
    tokenizer = AutoTokenizer.from_pretrained(model_path,trust_remote_code = True)
...
def get_complex_react_data_batch(model_path,input_complex_question_json, save_complex_react_qa_json,  except_comple_react_json,inference_batch_size=8,tensor_parallel_size=8):
    tokenizer = AutoTokenizer.from_pretrained(model_path,trust_remote_code = True)
...
if __name__ == "__main__":
    ...
    get_complex_react_data_batch(model_path,input_complex_question_json, save_complex_react_qa_json,  except_comple_react_json)
